...
const WORKFLOW_TEMPLATE = JSON.parse(
  fs.readFileSync(path.join(__dirname, "wan2_2_vace_v2v.json"), "utf8"),
);
...
/**
 * Wan 2.2 Fun VACE classic video-to-video (control video + prompt).
 *
 ...
 */
function WanVaceVideo2VideoWorkflow(overrides = {}) {
...
module.exports = WanVaceVideo2VideoWorkflow;
