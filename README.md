...
1. image generator server in **Node** (`/server`, `/public`) that drives **ComfyUI** over HTTP (managed Comfy process + `server/generator/workflows` JSON graphs).
